...
setwd("C:/Users/mayar/Desktop/Personnal/FGV/Estatistica_Espacial/Projeto_conclusao")
```
...
library(imager)
load.image("C:/Users/mayar/Desktop/Personnal/FGV/Estatistica_Espacial/Projeto_conclusao/Filadelpfia_dataset_description.png") %>% plot
```

<br>
-- Base Municipios Mensal
```{r loadimage, echo=FALSE}
load.image("C:/Users/mayar/Desktop/Personnal/FGV/Estatistica_Espacial/Projeto_conclusao/LesoesRoubos_dataset_description.png") %>% plot
```
<br>
  -- Base Evolução Populacional Mensal
```{r loadimage, echo=FALSE}
load.image("C:/Users/mayar/Desktop/Personnal/FGV/Estatistica_Espacial/Projeto_conclusao/EvolucaoPop_dataset_description.png") %>% plot
```
